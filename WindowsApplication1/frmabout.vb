...
Friend Class frmAbout
    ...
    Private Sub frmAbout_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf DocuFiSession.IsEvaluation Then
            lblResult.Text = "Your license is registered as a Trial."
            pictStatus.Image = imgList32.Images("certificate_ok.ico")
        Else
    ...
    Private Sub lblSponsorWeb_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblSponsorWeb.Click
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClearLicenses.Click
        ...
        If myresp = MsgBoxResult.Yes Then
            ...
            If IO.File.Exists(APP_Path() & "ComParaLicense.lic") Then
                IO.File.Delete(APP_Path() & "ComParaLicense.lic")
            End If
            Me.Close()
            frmLicense.Show()
        End If
